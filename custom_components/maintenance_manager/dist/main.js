...
const qa = { class: "flex flex-col gap-10 justify-center m-6" }, Ha = { class: "flex items-center justify-between pb-5" }, La = { class: "flex-shrink-0" }, Va = { class: "flex flex-col" }, Ba = { class: "flex gap-5 text-2xl items-center" }, Ua = {
  ...
  setup(e) {
    ...
    const st = (P) => P.map((m) => {
      ...
      i.value || (o.value = r.value), i.value == "areas" && dt();
    }, ne = () => {
      ...
      try {
        h.value ? await Xl(t.hass, s.value) : await Gl(t.hass, s.value), r.value = await Qt(t.hass), o.value = st(r.value), ut(), ne();
      } catch (P) {
      ...
      if (t.hass)
        try {
          await Jl(t.hass, E.value), p.value = !1, E.value = "null", r.value = await Qt(t.hass), o.value = st(r.value), ut();
        } catch (P) {
      ...
      if (t.hass)
        try {
          await Yl(t.hass, y.value, n.value), u.value = !1, y.value = "null", n.value = {}, l.value = await Xn(t.hass), r.value = await Qt(t.hass), o.value = st(r.value), ut();
        } catch (P) {
